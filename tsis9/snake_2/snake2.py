...
#create game's display
WIDTH, HEIGHT = 800, 640
BLOCK_SIZE = 35 #food and block size
...
class Snake():
    ...
    def draw(self):
        ...
        pygame.draw.rect(SCREEN, WHITE,
            pygame.Rect(head.x * BLOCK_SIZE, head.y * BLOCK_SIZE, BLOCK_SIZE, BLOCK_SIZE))
        for body in self.body[1:]:
            pygame.draw.rect(SCREEN, RED,
                pygame.Rect(body.x * BLOCK_SIZE, body.y * BLOCK_SIZE, BLOCK_SIZE, BLOCK_SIZE))
