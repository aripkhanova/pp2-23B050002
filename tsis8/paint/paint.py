...
def drawLine(screen, element1, element2):
    ...
    elif mode == 2: drawCirc(screen, element1, element2) # to keep old drawings unchanged
    elif mode == 1: drawRectangle(screen, element1, element2)

def drawRectangle(screen, element1, element2):
    start, color, mode, width = element1
    end = element2[0]
    ...
    elif mode == 0: drawLine(screen, element1, element2)

def drawCirc(screen, element1, element2):
    ...
    elif mode == 1: drawRectangle(screen, element1, element2) # to keep old drawings unchanged
    elif mode == 0: drawLine(screen, element1, element2)
...
def main():
    ...
    while running:        
        ...
        if draw_object == 0:
            ...
            i = 0
            while i < len(points) - 1:
                drawRectangle(screen, points[i], points[i + 1])
                i += 1
        elif draw_object == 2:
            i = 0
            while i < len(points) - 1:
                drawCirc(screen, points[i], points[i + 1])
                i += 1
